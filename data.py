...
style_models_file = ['wet.t7', 'rose.t7', 'landscape.t7', 'obscure.t7', 'heating.t7', 'flame.t7', 'Fire.t7', 'candy.t7', 'composition_vii.t7', 'feathers.t7', 'la_muse.t7', 'mosaic.t7', 'starry_night.t7', 'the_scream.t7', 'the_wave.t7', 'udnie.t7']

style_models_name = ['wet', 'rose', 'landscape', 'obscure', 'heating', 'flame', 'Fire', 'Candy', 'Composition_vii', 'Feathers', 'La_muse', 'Mosaic', 'Starry_night', 'The_scream', 'The_wave', 'Udnie']
